...
<div class="container-fluid">
        ...
        if (isset($_SESSION['loginuser'])) {
         ...
         ?>
					<div class="hov-dropdown d-inline-block col-lg-4 col-10">
          			<a class="text-decoration-none text-dark font-weight-bold" href="#" id="navbarDropdown2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          				<span class="mr-2"> <?=$_SESSION['loginuser'] ['name']?> </span>
					...
					<div class="col-lg-4 col-10">
						<a href="login.php" class="d-xl-block d-lg-block d-md-block d-none  text-decoration-none loginLink float-right"> Login   </a>
						<a href="register.php" class="d-xl-block d-lg-block d-md-block d-none  text-decoration-none loginLink float-right">  Sign-up | </a>
						...
						<?php 
						 ...
						 ?>
			          	<li class="dropdown-submenu">
							...
							Where category_id=:id ORDER BY name
							";
							$stmt=$conn->prepare($sql);
		...
		<div class="mt-3">
			...
			<div class="collapse sidebardropdown_container_category mt-3" id="category">
				<?php 
						 ...
						 ?>
			    <a data-toggle="collapse" href="#subcategory<?=$cid?>" role="button" aria-expanded="false" aria-controls="category" class="py-2"> <?=$cname ?> <i class="icofont-rounded-down float-right mr-3"></i></a>
			   	
					<div class="collapse sidebardropdown_container_category mt-3" id="subcategory<?=$cid?>">
							<?php 
