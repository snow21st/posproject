...
<main class="app-content">
            <div class="app-title">
                ...
                <ul class="app-breadcrumb breadcrumb side">
                    <a href="categorieslist.php" class="btn btn-outline-primary">
                        ...
                        <div class="tile-body">
                            <form action="category_update.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                      <input type="text" class="form-control" id="name_id" name="name" value="<?php echo $category['name'] ?> ">
        ...
        <div class="tab-content" id="pills-tabContent">
          <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
   			<img src="<?php echo $category['photo'] ?>" alt="" style="width: 250px;height: 150px">
          </div>
