...
<html lang="en">
    ...
    <body class="app sidebar-mini">
        ...
        <aside class="app-sidebar">
            <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src=" <?=$_SESSION['loginuser']['profile'] ?> " alt="User Image" style="width: 60px;height: 60px;object-fit: cover;" >
                <div>
                    <p class="app-sidebar__user-designation"><?=$_SESSION['loginuser'] ['name']?>  </p>
                  <p class="app-sidebar__user-name"> <?=$_SESSION['loginuser'] ['rname']?> </p>
            ...
            <ul class="app-menu">
                ...
                <li>
                    <a class="app-menu__item" href="item-list.php">
                ...
                <li>
                    <a class="app-menu__item" href="categorieslist.php">
