...
$query="SELECT items.*,brands.name as bname
FROM items
LEFT JOIN brands
...
$newprice = ((int)$items->price) - ((int)$items->discount);
?>
<div class="jumbotron jumbotron-fluid subtitle">
  		<div class="container">
    		<h1 class="text-center text-white"> <?=$items->name ?> </h1>
  		</div>
	</div>
	...
	<div class="container">
		...
		<div class="row mt-5">
			...
			<div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
				...
				<p> 
					...
					<span class="maincolor ml-3 font-weight-bolder"> <?=$newprice ?></span>
				</p>
		...
		<div class="row mt-5">
			...
			<?php 
			$sql="SELECT * from items  where subcategory_id=$items->subcategory_id";
$stmt=$conn->prepare($query);
$stmt->bindParam(':id',$id);
$stmt->execute();
